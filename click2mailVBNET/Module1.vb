...
Module Module1
    ...
    Sub Main()
        ...
        Dim fileName As String = "C:\test\test.pdf"
        Dim liveMode As Boolean = False
        ...
        "    </job>" &
        "</batch>"
        startHereBatch(username, password, fileName, xml, liveMode)

        'startHereRest("username", "password")
    ...
    Private Sub startHereRest(ByVal username As String, ByVal password As String)
        ...
        al.Add(New addressItem("TestFName", "TestLName", "", "1234 Test Street", "Ste 335", "", "Oak Brook", "IL", "60523", ""))
    ...
    Private Sub startHereBatch(ByVal username As String, ByVal password As String, ByVal fileName As String, ByVal XML As String, Optional ByVal liveMode As Boolean = False)
        'Assign your file
        _username = username
        _password = password
        _XMLDOC = New XmlDocument
    ...
    Public Function PutObjectTest(postUrl As String) As [String]
